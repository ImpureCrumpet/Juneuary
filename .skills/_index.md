...
Kit version: see `.skills/_meta.yml`. Vendored from [skills-harness](https://github.com/Gargoyle-Apps/skills-harness) at `.skills-harness/`.
...
| j-ytd-report | Generate the machine-readable YTD microseasons markdown report from the local DB. | ytd report, tabular report, generate report, microseason report, seattle report tables |
| j-narrative-report | Write a human narrative YTD report with season timeline and lived-experience commentary. | narrative report, season timeline, commentary report, write up the year, microseason story |
